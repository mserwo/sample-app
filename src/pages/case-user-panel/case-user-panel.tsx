...
export const CaseUserPanel = () => {
  return (
    <Layout>
      <PageLayout>
        <TitleLayout>Panel użytkownika - opis procesu</TitleLayout>
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              Po zalogowaniu użytkownika zostajemy przekierowani na stronę
              główną aplikacji. W pierwszej kolejności wykonują się instruckje
              zawarte w <b>useEffect()</b>, mające na celu pobranie aktualnych
              danych użytkownika z backendu. Sam proces łączenia się z serwerem
              i pobierania danych opisany jest w kolejnym punkcie.
            </div>
            <div style={{ marginBottom: "15px" }}>
              Jeśli użytkownik został zalogowany, a jego dane poprawnie pobrane,
              wyświetlana jest sekcja z danymi użytkownika takimi jak <b>ID </b>
              oraz adres <b>email</b>. Na końcu sekcji wyświetla się przycisk z
              przekierowaniem do panelu użytkonika gdzie znjajdują się wszystkie
              dane oraz możliwość ich edycji.
            </div>
            <div>
          ...
          <PicsLayout>
            <img
              src={case_user_panel_1}
              alt="pobranie danych uzytkownika"
            ></img>
            <img
        ...
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              Używając <b>tokenu</b>, który pobieramy z globalnego kontekstu (
              <b>usecontext()</b>), wykonujemy <b>fetcha</b> łącząc się z
              endpointem <b>/me</b>. W tym celu wysyłamy zapytanie{" "}
              <b>metodą GET</b>, używającąc nagłówków z m.in. autoryzacją{" "}
              <b>'Bearer token'</b>.
            </div>
            <div>
              Otrzymane dane w postai obiektu Response odczytujemy w formacie
              <b> JSON</b> zwracając <b>ID</b> oraz <b>email</b>.
            </div>
          </TextLayout>
          <PicsLayout>
        ...
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              Endpoint <b>/me</b> działa podobnie jak <b>/getData</b> opisany w
              procesie logowania. W pierwszej kolejności uruchamiany jest
              <b> middleware veryfiUser</b> (opisany również w pkt. 7 procesu
              logowania), który na podstawie otrzymanego <b>tokenu</b>, dekoduje
              go i zwraca odszyfrowane <b>ID</b> użytkownika zawarte wcześniej w
              tokenie.
            </div>
            <div>
              Po prawidłowym uwierzytelnieniu wracamy do endpointu <b>/me</b>,
              który uruchamia funkcję <b>readUsers()</b>, ta z kolei odczytuje
        ...
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              przekierowany na stronę: <b>userpage:userId</b>.
            </div>
            <div style={{ marginBottom: "15px" }}>
              W panelu użytkownika wykonywany jest kolejny <b>useEffect</b>
              który:
            </div>
            <ul style={{ marginBottom: "15px" }}>
              <li style={{ listStyle: "inside" }}>
                ponownie wysyła token do backendu (endpoint <b>/readUserData</b>
                ),
              </li>
              <li style={{ listStyle: "inside" }}>
              ...
              <li style={{ listStyle: "inside" }}>
                dane są ustawiane w stanie komponentu (userData) oraz
                jednocześnie w globalnym kontekście (<b>UserContext</b>).
              </li>
            </ul>
        ...
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              się przy użyciu biblioteki <b>Yup</b>), co uruchamia funkcję
              <b> handleSubmit()</b>. Jej zadaniem jest zebranie wszystkich
              aktualnie wypełnionych pól oraz wywołanie funkcji
              <b> updateUserData()</b>, odpowiedzialnej za wysłanie zmian do
              backendu.
            </div>
            <div style={{ marginBottom: "15px" }}>
              ...
              zapisywane w formcie JSON (<b>API</b>) i przesyłane na endpoint
              <b>/updateUser metodą PUT</b>. W nagłówkach wykorzystywany jest
              token użytkownika, przekazywany jako{" "}
              <b>Authorization: Bearer Token</b>, co pozwala backendowi
              jednoznacznie potwierdzić, który użytkownik wysłał żądanie.
            </div>
            <div style={{ marginBottom: "15px" }}>
              Jeżeli backend poprawnie zapisze dane, komponent aktualizuje
              lokalny stan (<b>setDataUpdate(true)</b>) oraz wyłącza tryb
              edycji, co powoduje powrót do widoku podglądu. W przypadku błędów
              wyświetlany jest odpowiedni komunikat, a sam backend zwraca status
              błędu widoczny w konsoli.
            </div>
          </TextLayout>
          <PicsLayout>
        ...
        <SectionLayout>
          <TextLayout>
            ...
            <div style={{ marginBottom: "15px" }}>
              Endpoint odpowiedzialny za aktualizację danych użytkownika działa
              w oparciu o <b>metodę PUT</b> oraz wcześniej stworzone{" "}
              <b>middleware verifyUser</b> (opisany szczegółowo w pkt. 7 procesu
              logowania). To właśnie middleware przejmuje token wysłany w
              nagłówku i odszyfrowuje z niego identyfikator użytkownika, który
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              Następnie backend odnajduje w bazie danych (w tym przypadku w
              pliku <b>JSON</b> z danymi użytkownikow) użytkownika o przekazanym{" "}
              <b>ID</b>.
            </div>
            <div style={{ marginBottom: "15px" }}>
              ...
              frontend, albo stara wartość, jeśli użytkownik nie wprowadził
              zmian.
            </div>
            <div>
              Po zakończeniu procesu backend zapisuje zaktualizowaną listę
              użytkowników (<b>writeUsers()</b>)i zwraca odpowiedź z komunikatem
              potwierdzającym pomyślną aktualizację. Jeśli nie uda się odnaleźć
              użytkownika lub wystąpi błąd zapisu, endpoint zwraca odpowiednio
              status 404 lub 500, wraz z opisem błędu.
            </div>
          </TextLayout>
          <PicsLayout>
        ...
        <div className={styles.downContainer}>
          <div className={styles.caption2}>
            Zarejestruj się lub zaloguj i przetestuj jak działa panel
            użytkownika
          </div>
